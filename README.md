...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-vagrant/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-vagrant/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-vagrant.svg)](https://github.com/buluma/ansible-role-vagrant/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-vagrant.svg)](https://github.com/buluma/ansible-role-vagrant/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-vagrant.svg)](https://github.com/buluma/ansible-role-vagrant/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/vagrant)](https://galaxy.ansible.com/ui/standalone/roles/buluma/vagrant/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-vagrant/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-vagrant
